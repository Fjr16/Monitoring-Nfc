    ...
    <form action="{{ route('user.store') }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-md-10">
                  <input class="form-control @error('pin_number') is-invalid @enderror" type="number" oninput="this.value=this.value.slice(0,6)" value="{{ old('pin_number') }}" id="pin_number" name="pin_number" />
                    @error('pin_number')
                        <div class="text-danger">
                            *{{ $message }}
                        </div>
